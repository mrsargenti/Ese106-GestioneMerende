...
public class Ese106 {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			if(e.getMessage().equals("il panino non può essere vegetariano e contenere carne"))
				System.out.println("OK");
			else
				System.out.println("ERRORE");
		}
		...
		try {
			...
			if(e.getMessage().equals("a non può essere null"))
				System.out.println("OK");
			else
				System.out.println("ERRORE");
		}
		...
		try {
			...
			if(e.getMessage().equals("in questa data la classe ha gia effettuato un ordine"))
				System.out.println("OK");
			else
				System.out.println("ERRORE");
		}
